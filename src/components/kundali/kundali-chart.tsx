...
import { Calendar, Clock, MapPin, Loader2, ChevronUp, ChevronDown } from 'lucide-react';
...
const KundaliChart: React.FC<KundaliChartProps> = ({ birthDetails, kundaliData, isLoading = false, defaultCollapsed = false }) => {
  ...
  return (
    <div className="w-full h-full">
      <div className="bg-gradient-to-br from-orange-50 to-white backdrop-blur-sm rounded-xl shadow-lg p-3 sm:p-4 space-y-3 sm:space-y-4">
